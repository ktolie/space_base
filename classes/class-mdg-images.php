...
class MDG_Images {
	...
	public function set_image_sizes() {
		...
		$this->image_sizes[] = array(
			'width'   => 444,
			'height'  => 376,
			'title'   => 'home-page-slide-image-size', // The default will be widthxheight but any string can be used
			'used_in' => array(
				'title' => 'Home Page Slide Image', // Title to be used in Media notification
				'link'  => '', // Link to an image of the created size to be used in Media notification
			)
		);
		...
		$this->image_sizes[] = array(
			'width'   => 158,
			'height'  => 106,
			'title'   => 'related-news-image-size', // The default will be widthxheight but any string can be used
			'used_in' => array(
				'title' => 'Related News Image', // Title to be used in Media notification
				'link'  => '', // Link to an image of the created size to be used in Media notification
			)
		);
		...
		$this->image_sizes[] = array(
			'width'   => '',
			'height'  => 450,
			'title'   => 'page-header-image', // The default will be widthxheight but any string can be used
			'used_in' => array(
				'title' => 'Featured Page Image', // Title to be used in Media notification
				'link'  => '', // Link to an image of the created size to be used in Media notification
			)
		);
		...
		$this->image_sizes[] = array(
			'width'   => 150,
			'height'  => 150,
			'title'   => 'service-thumb-image', // The default will be widthxheight but any string can be used
			'used_in' => array(
				'title' => 'Service Thumb Image', // Title to be used in Media notification
				'link'  => '', // Link to an image of the created size to be used in Media notification
			)
		);
		...
		$this->image_sizes[] = array(
			'width'   => 723,
			'height'  => 275,
			'title'   => 'news-roll-image', // The default will be widthxheight but any string can be used
			'used_in' => array(
				'title' => 'News Roll Image', // Title to be used in Media notification
				'link'  => '', // Link to an image of the created size to be used in Media notification
			)
		);

		// Media Center Slide Image
		$this->image_sizes[] = array(
			'width'   => 723,
			'height'  => 334,
			'title'   => 'media-center-slide-image', // The default will be widthxheight but any string can be used
			'used_in' => array(
				'title' => 'Media Center Slide Image', // Title to be used in Media notification
				'link'  => '', // Link to an image of the created size to be used in Media notification
			)
		);
